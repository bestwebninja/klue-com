...
export const DASHBOARD_TEMPLATE_REGISTRY: Record<string, DashboardTemplateConfig> = {
  ...
  hvac: createTemplate({
    ...
    widgetKeys: ['profile_summary', 'weather', 'area_risk', 'jobs', 'site_manager', 'ai_next_action'],
    defaultLayout: baseLayout,
  }),
  plumbing: createTemplate({ key: 'plumbing', label: 'Plumbing Dashboard', userCategory: 'subcontractor', version: 1, navItems: [{ key: 'home', label: 'Home' }, { key: 'jobs', label: 'Jobs' }, { key: 'inventory', label: 'Inventory' }, { key: 'ai', label: 'AI' }], widgetKeys: ['profile_summary', 'weather', 'area_risk', 'jobs', 'site_manager', 'ai_next_action'], defaultLayout: baseLayout }),
  electrical: createTemplate({ key: 'electrical', label: 'Electrical Dashboard', userCategory: 'subcontractor', version: 1, navItems: [{ key: 'home', label: 'Home' }, { key: 'jobs', label: 'Jobs' }, { key: 'safety', label: 'Safety' }, { key: 'ai', label: 'AI' }], widgetKeys: ['profile_summary', 'weather', 'area_risk', 'jobs', 'site_manager', 'compliance', 'ai_next_action'], defaultLayout: baseLayout }),
  roofing: createTemplate({ key: 'roofing', label: 'Roofing Dashboard', userCategory: 'subcontractor', version: 1, navItems: [{ key: 'home', label: 'Home' }, { key: 'jobs', label: 'Jobs' }, { key: 'claims', label: 'Claims' }, { key: 'ai', label: 'AI' }], widgetKeys: ['profile_summary', 'weather', 'area_risk', 'jobs', 'site_manager', 'project_alerts', 'ai_next_action'], defaultLayout: baseLayout }),
  painting: createTemplate({ key: 'painting', label: 'Painting Dashboard', userCategory: 'subcontractor', version: 1, navItems: [{ key: 'home', label: 'Home' }, { key: 'jobs', label: 'Jobs' }, { key: 'schedule', label: 'Schedule' }, { key: 'ai', label: 'AI' }], widgetKeys: ['profile_summary', 'weather', 'area_risk', 'jobs', 'site_manager', 'ai_next_action'], defaultLayout: baseLayout }),
  carpentry: createTemplate({ key: 'carpentry', label: 'Carpentry Dashboard', userCategory: 'subcontractor', version: 1, navItems: [{ key: 'home', label: 'Home' }, { key: 'jobs', label: 'Jobs' }, { key: 'materials', label: 'Materials' }, { key: 'ai', label: 'AI' }], widgetKeys: ['profile_summary', 'weather', 'jobs', 'site_manager', 'suppliers', 'ai_next_action'], defaultLayout: baseLayout }),
