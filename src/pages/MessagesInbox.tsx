...
const MessagesInbox = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Messages Inbox | Kluje" description="View and reply to messages from service providers and customers. Keep all your job conversations organised in one inbox." noIndex={true} />
      <Navbar />
                ...
                {isLoading ? (
                  ...
                  <div className="divide-y">
                    {filteredConversations.map((conv) => (
                      ...
                      >
                        ...
                        <ChevronRight className="h-5 w-5 text-muted-foreground shrink-0 self-center lg:hidden" />
                      </button>
                    ))}
                  </div>
                ) : (
                  <div className="text-center py-12 px-4">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Messages will appear here when you start chatting with providers or job posters.
                    </p>
                  </div>
                )}
              </CardContent>
