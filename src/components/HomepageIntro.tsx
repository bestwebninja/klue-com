      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6 text-center">
            Find Trusted Service Providers Across the UK
          </h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Kluje is the UK's growing marketplace connecting homeowners, landlords and businesses with
              trusted local service providers. Whether you need a{' '}
              <Link to="/services/home-diy-renovation" className="text-primary hover:underline">plumber in London</Link>,
              an{' '}
              <Link to="/services/it-services" className="text-primary hover:underline">IT consultant in Manchester</Link>,
              or a{' '}
              <Link to="/services/events-catering" className="text-primary hover:underline">wedding caterer in Edinburgh</Link>,
              our platform makes it simple to find qualified professionals near you.
            </p>
            <p>
              Post your job for free and receive up to three tailored quotes from vetted tradespeople and
              service providers across England, Scotland, Wales and Northern Ireland. Every professional on
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            ...
            <div className="flex flex-col items-center text-center gap-2 p-4 rounded-lg bg-muted/50">
              ...
              <span className="text-sm font-medium text-foreground">UK-Wide Coverage</span>
              <span className="text-xs text-muted-foreground">Local pros, nationwide</span>
            </div>
          </div>
        </div>
      </div>
